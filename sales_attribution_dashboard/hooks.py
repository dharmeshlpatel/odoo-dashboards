...
OWN = (
    "sales_attribution_dashboard.blueprint_sales_campaigns",
    "sales_attribution_dashboard.blueprint_sales_mediums",
    "sales_attribution_dashboard.blueprint_sales_sources",
)
SHARE_GROUPS = (
